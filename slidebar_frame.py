...
#      play list btn frame
        ...
        self.add_to_playlist_image = CTkImage(light_image=Image.open('assets/add_light.png'),dark_image=Image.open('assets/add_dark.png'),size =(20,20))
        self.remove_playlist_image = CTkImage(light_image=Image.open('assets/remove_light.png'),dark_image=Image.open('assets/remove_dark.png'),size =(20,20))

        self.add_to_playlist_btn =CTkButton(master=self.bts_frame, text='', fg_color='transparent', image= self.add_to_playlist_image, command=self.add_music)
        self.remove_playlist_btn =CTkButton(master=self.bts_frame,text='', fg_color='transparent',image= self.remove_playlist_image , command=self.remove_music)
